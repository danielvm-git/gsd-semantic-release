...
```bash
# Claude Code
npx @danielvm/gsd-semantic-release --claude --global   # 安装到 ~/.claude/
npx @danielvm/gsd-semantic-release --claude --local    # 安装到 ./.claude/

# OpenCode
npx @danielvm/gsd-semantic-release --opencode --global # 安装到 ~/.config/opencode/

# Gemini CLI
npx @danielvm/gsd-semantic-release --gemini --global   # 安装到 ~/.gemini/

# Kilo
npx @danielvm/gsd-semantic-release --kilo --global     # 安装到 ~/.config/kilo/
npx @danielvm/gsd-semantic-release --kilo --local      # 安装到 ./.kilo/

# Codex
npx @danielvm/gsd-semantic-release --codex --global    # 安装到 ~/.codex/
npx @danielvm/gsd-semantic-release --codex --local     # 安装到 ./.codex/

# Copilot
npx @danielvm/gsd-semantic-release --copilot --global  # 安装到 ~/.github/
npx @danielvm/gsd-semantic-release --copilot --local   # 安装到 ./.github/

# Cursor CLI
npx @danielvm/gsd-semantic-release --cursor --global   # 安装到 ~/.cursor/
npx @danielvm/gsd-semantic-release --cursor --local    # 安装到 ./.cursor/

# Antigravity
npx @danielvm/gsd-semantic-release --antigravity --global # 安装到 ~/.gemini/antigravity/
npx @danielvm/gsd-semantic-release --antigravity --local  # 安装到 ./.agent/

# Augment
npx @danielvm/gsd-semantic-release --augment --global     # 安装到 ~/.augment/
npx @danielvm/gsd-semantic-release --augment --local      # 安装到 ./.augment/

# Trae
npx @danielvm/gsd-semantic-release --trae --global     # 安装到 ~/.trae/
npx @danielvm/gsd-semantic-release --trae --local      # 安装到 ./.trae/

# CodeBuddy
npx @danielvm/gsd-semantic-release --codebuddy --global # 安装到 ~/.codebuddy/
npx @danielvm/gsd-semantic-release --codebuddy --local  # 安装到 ./.codebuddy/

# Cline
npx @danielvm/gsd-semantic-release --cline --global       # 安装到 ~/.cline/
npx @danielvm/gsd-semantic-release --cline --local        # 安装到 ./.clinerules

# 所有运行时
npx @danielvm/gsd-semantic-release --all --global      # 安装到所有目录
```
...
**命令行为不符合预期？**
- 运行 `/gsd-help` 确认安装成功
- 重新执行 `npx @danielvm/gsd-semantic-release` 进行重装
...
OpenCode、Gemini CLI、Kilo 和 Codex 现在都已经通过 `npx @danielvm/gsd-semantic-release` 获得原生支持。
