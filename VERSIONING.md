...
|------|-----------|---------------|---------|--------|---------|
| **Patch** | Bug fixes only | `1.27.1` | `latest` | `hotfix/1.27.1` | `npx @danielvm/gsd-semantic-release@latest` |
| **Minor** | Fixes + enhancements | `1.28.0` | `latest` (after RC) | `release/1.28.0` | `npx @danielvm/gsd-semantic-release@next` (RC) |
| **Major** | Fixes + enhancements + features | `2.0.0` | `latest` (after beta) | `release/2.0.0` | `npx @danielvm/gsd-semantic-release@next` (beta) |
...
|-----|---------|-------------|
| `latest` | Stable production release | `npm install @danielvm/gsd-semantic-release` (default) |
| `next` | Pre-release (RC or beta) | `npm install @danielvm/gsd-semantic-release@next` (opt-in) |
...
4. Test the RC: `npx @danielvm/gsd-semantic-release@next`
...
npm dist-tag ls @danielvm/gsd-semantic-release
```
