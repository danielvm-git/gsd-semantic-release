...
```bash
# Claude Code
npx @danielvm/gsd-semantic-release --claude --global   # ~/.claude/에 설치
npx @danielvm/gsd-semantic-release --claude --local    # ./.claude/에 설치

# OpenCode
npx @danielvm/gsd-semantic-release --opencode --global # ~/.config/opencode/에 설치

# Gemini CLI
npx @danielvm/gsd-semantic-release --gemini --global   # ~/.gemini/에 설치

# Kilo
npx @danielvm/gsd-semantic-release --kilo --global     # ~/.config/kilo/에 설치
npx @danielvm/gsd-semantic-release --kilo --local      # ./.kilo/에 설치

# Codex
npx @danielvm/gsd-semantic-release --codex --global    # ~/.codex/에 설치
npx @danielvm/gsd-semantic-release --codex --local     # ./.codex/에 설치

# Copilot
npx @danielvm/gsd-semantic-release --copilot --global  # ~/.github/에 설치
npx @danielvm/gsd-semantic-release --copilot --local   # ./.github/에 설치

# Cursor CLI
npx @danielvm/gsd-semantic-release --cursor --global      # ~/.cursor/에 설치
npx @danielvm/gsd-semantic-release --cursor --local       # ./.cursor/에 설치

# Antigravity
npx @danielvm/gsd-semantic-release --antigravity --global # ~/.gemini/antigravity/에 설치
npx @danielvm/gsd-semantic-release --antigravity --local  # ./.agent/에 설치

# Augment
npx @danielvm/gsd-semantic-release --augment --global     # ~/.augment/에 설치
npx @danielvm/gsd-semantic-release --augment --local      # ./.augment/에 설치

# Trae
npx @danielvm/gsd-semantic-release --trae --global        # ~/.trae/에 설치
npx @danielvm/gsd-semantic-release --trae --local         # ./.trae/에 설치

# Cline
npx @danielvm/gsd-semantic-release --cline --global       # ~/.cline/에 설치
npx @danielvm/gsd-semantic-release --cline --local        # ./.clinerules에 설치

# 전체 런타임
npx @danielvm/gsd-semantic-release --all --global      # 모든 디렉터리에 설치
```
...
- `npx @danielvm/gsd-semantic-release`를 다시 실행해 재설치
...
OpenCode, Gemini CLI, Kilo, Codex는 이제 `npx @danielvm/gsd-semantic-release`를 통해 기본 지원됩니다.
