...
```bash
# Claude Code
npx @danielvm/gsd-semantic-release --claude --global   # ~/.claude/ にインストール
npx @danielvm/gsd-semantic-release --claude --local    # ./.claude/ にインストール

# OpenCode
npx @danielvm/gsd-semantic-release --opencode --global # ~/.config/opencode/ にインストール

# Gemini CLI
npx @danielvm/gsd-semantic-release --gemini --global   # ~/.gemini/ にインストール

# Kilo
npx @danielvm/gsd-semantic-release --kilo --global     # ~/.config/kilo/ にインストール
npx @danielvm/gsd-semantic-release --kilo --local      # ./.kilo/ にインストール

# Codex
npx @danielvm/gsd-semantic-release --codex --global    # ~/.codex/ にインストール
npx @danielvm/gsd-semantic-release --codex --local     # ./.codex/ にインストール

# Copilot
npx @danielvm/gsd-semantic-release --copilot --global  # ~/.github/ にインストール
npx @danielvm/gsd-semantic-release --copilot --local   # ./.github/ にインストール

# Cursor CLI
npx @danielvm/gsd-semantic-release --cursor --global      # ~/.cursor/ にインストール
npx @danielvm/gsd-semantic-release --cursor --local       # ./.cursor/ にインストール

# Antigravity
npx @danielvm/gsd-semantic-release --antigravity --global # ~/.gemini/antigravity/ にインストール
npx @danielvm/gsd-semantic-release --antigravity --local  # ./.agent/ にインストール

# Augment
npx @danielvm/gsd-semantic-release --augment --global     # ~/.augment/ にインストール
npx @danielvm/gsd-semantic-release --augment --local      # ./.augment/ にインストール

# Trae
npx @danielvm/gsd-semantic-release --trae --global        # ~/.trae/ にインストール
npx @danielvm/gsd-semantic-release --trae --local         # ./.trae/ にインストール

# Cline
npx @danielvm/gsd-semantic-release --cline --global       # ~/.cline/ にインストール
npx @danielvm/gsd-semantic-release --cline --local        # ./.clinerules にインストール

# 全ランタイム
npx @danielvm/gsd-semantic-release --all --global      # すべてのディレクトリにインストール
```
...
- `npx @danielvm/gsd-semantic-release` を再実行して再インストールしてください
...
OpenCode、Gemini CLI、Kilo、Codexは `npx @danielvm/gsd-semantic-release` でネイティブサポートされています。
